...
export default function FeedCard({ dispatch, onLike, onRepost }: FeedCardProps) {
  ...
  return (
    <article 
      ...
      className={cn(
        "group cursor-pointer w-full max-w-xl mx-auto border-b border-border/40 py-4.5 px-3 sm:px-4 hover:bg-muted/15 transition-colors text-foreground font-sans"
      )}
    >
