...
const BreakingTicker = () => {
  ...
  return (
    <div className="marquee-strip flex items-center h-10 border-b border-border bg-background">
      ...
      <div className="flex-1 overflow-hidden relative before:absolute before:left-0 before:top-0 before:bottom-0 before:w-8 before:bg-gradient-to-r before:from-background before:to-transparent before:pointer-events-none before:z-10 after:absolute after:right-0 after:top-0 after:bottom-0 after:w-8 after:bg-gradient-to-l after:from-background after:to-transparent after:pointer-events-none after:z-10">
        <div
