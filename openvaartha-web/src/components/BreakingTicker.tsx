        ...
        <Marquee pauseOnHover className="[--duration:40s] [--gap:0]" style={{ padding: 0 }}>
          {latest.map((item) => (
            <Link 
              ...
              className="font-display text-xs sm:text-[13px] font-semibold tracking-tight flex items-center gap-5 text-[#FFF8E7] hover:text-white transition-colors mx-4 h-full"
            >
              {item.title}
